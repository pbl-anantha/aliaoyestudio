          ...
          <table className="min-w-[820px] w-full table-fixed border-collapse text-xs sm:min-w-0 sm:text-sm">
            <thead className="bg-[#dd98ad] text-[#7d344b]">
              <tr className="text-center">
                <th className="w-[5%] border border-[#c88ca1] px-2 py-2 sm:w-[4%] sm:px-3">No</th>
                <th className="w-[9%] border border-[#c88ca1] px-2 py-2 sm:w-[10%] sm:px-3">Tanggal</th>
                <th className="w-[9%] border border-[#c88ca1] px-2 py-2 sm:w-[10%] sm:px-3">Status</th>
                <th className="w-[9%] border border-[#c88ca1] px-2 py-2 sm:w-[10%] sm:px-3">Jam Buka</th>
                <th className="w-[9%] border border-[#c88ca1] px-2 py-2 sm:w-[10%] sm:px-3">Jam Tutup</th>
                <th className="w-[21%] border border-[#c88ca1] px-2 py-2 sm:w-[26%] sm:px-3">Catatan</th>
                <th className="w-[15%] border border-[#c88ca1] px-2 py-2 sm:w-[14%] sm:px-3">Aksi</th>
              </tr>
            </thead>
            ...
            <tbody className="bg-white/70 text-[#7d344b] font-medium">
              {data.map((item) => (
                <tr key={item.no}>
                  ...
                  <td className="border border-[#e2b6c4] px-2 py-2 text-center align-top break-words sm:px-3">{item.status}</td>
                  <td className="border border-[#e2b6c4] px-2 py-2 text-center align-top break-words sm:px-3">{item.jamBuka}</td>
                  <td className="border border-[#e2b6c4] px-2 py-2 text-center align-top break-words sm:px-3">{item.jamTutup}</td>
