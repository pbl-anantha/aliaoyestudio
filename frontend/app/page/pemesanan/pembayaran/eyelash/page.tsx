...
export default function PembayaranEyelash() {
                    ...
                    <div className="space-y-4 px-5 py-4 text-xs text-[#7D344B] sm:text-sm">
                        <div className="rounded-lg border border-[#dd98ad] bg-[#ffecf2] p-4 shadow-soft-text">
                            ...
                            <div className="space-y-3">
                                <InputReadonly label="Kode Pesanan" value="ORD002" />
                                <InputReadonly label="Nama Pelanggan" value="Anann" />
                                <InputReadonly label="Layanan" value="Eyelash" />
                                <InputReadonly label="Tanggal" value="1 September 2025" />
                                <InputReadonly label="Jam" value="13:00" />
                                <InputReadonly label="Jenis Lash" value="Korean Lash" />
