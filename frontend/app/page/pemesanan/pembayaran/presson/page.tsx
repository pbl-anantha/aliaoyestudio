...
export default function PembayaranPressOn() {
    const router = useRouter();

    const metodePengambilan = "antar"; 
                    ...
                    <div className="space-y-4 px-5 py-4 text-xs text-[#7D344B] sm:text-sm">
                        <div className="rounded-lg border border-[#dd98ad] bg-[#ffecf2] p-4 shadow-soft-text">
                            ...
                            <div className="space-y-3">
                                <InputReadonly label="Kode Pesanan" value="ORD004" />
                                <InputReadonly label="Nama Pelanggan" value="Fitria" />
                                ...
                                {metodePengambilan === "antar" && (
                                    <InputReadonly label="Alamat Pengiriman" value="Nusa Jaya" />
                                )}
